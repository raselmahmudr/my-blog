        ...
        <div className="container-1200 px-4">
            <div className="footer text-center grid grid-cols-1 gap-y-4 sm:grid-cols-2 md:grid-cols-4 md:text-left ">
                ...
                <div>
                    ...
                    <ul>
                        <li className="text-sm">  <PreloadLink className="text-gray-300" to="/author/profile/rasel_mahmud" >#Rasel</PreloadLink> </li>
                        <li className="text-sm">  <PreloadLink className="text-gray-300" to="/author/profile/Raju%20Sarker" >#Raju</PreloadLink> </li>
                        <li className="text-sm">  <PreloadLink className="text-gray-300" to="/author/profile/Apele%20Mahmud" >#Apele</PreloadLink> </li>
                    </ul>
                </div>
            ...
            <div className="bg-gray-9 max-w-max mx-auto bg-opacity-50 rounded">
                <div className="flex justify-center text-gray-900  mt-4 md:mt-0">
                    <h4 className="px-2 py-0.5 text-sm font-normal">Total Visitor {appState.visitors.total_visitors && appState.visitors.total_visitors.length > 0 ? appState.visitors.total_visitors.length: 0}  </h4>
                    <h4 className="px-2 py-0.5 font-normal text-sm">Visitors Total Hits {appState.visitors.day_visitors && appState.visitors.day_visitors.length > 0 ? appState.visitors.day_visitors.length: 0}  </h4>
                </div>
            </div>
        </div>
    </div>
