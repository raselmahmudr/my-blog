			...
			<div className="dark:bg-dark ">
				...
				<div className="mt-8">
					<div className="mx-auto " style={{maxWidth: "400px"}}>
						<h1 className="text-center mb-4 text-2xl dark_title">Sign in with email</h1>
						...
						{step === 1 ? takeEmail() : takePassword()}
							...
							<Link to="/auth/join"
										className="flex max-w-max rounded-full py-2 btn mx-auto px-5 mt-10 bg-gray-10 dark:text-gray-300 dark:bg-dark-500"
