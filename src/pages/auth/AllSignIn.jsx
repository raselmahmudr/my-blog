	...
	return (
		<div>
			...
			<div className="flex flex-col justify-center align-center mx-auto my-6" style={{maxWidth: "600px"}}>
				...
				<a href="http://localhost:3300/auth/google" className="max-w-max mt-4 bg-transparent rounded-full border border-gray-9 px-3 py-2 flex align-center ">
				...
				<a className=" max-w-max mt-4 bg-transparent rounded-full border border-gray-9 px-3 py-2 flex align-center " href="http://localhost:3300/auth/facebook">
